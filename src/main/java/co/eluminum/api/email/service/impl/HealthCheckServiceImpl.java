...
public class HealthCheckServiceImpl implements HealthCheckService {
    ...
    public HealthCheckServiceImpl(WebClient graphWebClient, @Value("${app.apiVersion}") String apiVersion) {
    ...
    private Mono<HealthResponse> performCheck() {
        ...
        return graphWebClient.get()
            // Querying the service principal by appId is the standard way to verify app-only connectivity
